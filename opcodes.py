...
print('/* generated by %s; only contains opcodes with defined 14..12 and 6..0 */' % sys.argv[0], file=outfile)
print('#ifndef %s\n#define %s' % (include_name, include_name), file=outfile)
...
for line in infile:
    ...
    print('#define\tOP_%s %#x' % (opcode, value), file=outfile)

print('#endif /* !%s */' % include_name, file=outfile)
